...
export const environment = {
    ...
    SASAKI_API_ENDPOINT: 'https://sskts-api-development-preview.azurewebsites.net',
    TOKEN_ISSUER: 'https://cognito-idp.ap-northeast-1.amazonaws.com/ap-northeast-1_bQcyLA7Jq'
};
