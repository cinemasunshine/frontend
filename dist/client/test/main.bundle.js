...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__services_purchase_purchase_service__ = __webpack_require__("../../../../../src/client/src/app/services/purchase/purchase.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__services_purchase_guard_purchase_guard_service__ = __webpack_require__("../../../../../src/client/src/app/services/purchase-guard/purchase-guard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__services_error_error_service__ = __webpack_require__("../../../../../src/client/src/app/services/error/error.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__services_call_native_call_native_service__ = __webpack_require__("../../../../../src/client/src/app/services/call-native/call-native.service.ts");
...
var PurchaseService = /** @class */ (function () {
    function PurchaseService(storage, sasakiService, awsCognito) {
        this.storage = storage;
        this.sasakiService = sasakiService;
        this.awsCognito = awsCognito;
        this.load();
    ...
    PurchaseService.prototype.load = function () {
        var data = this.storage.load('purchase', __WEBPACK_IMPORTED_MODULE_5__storage_storage_service__["a" /* SaveType */].Session);
        if (data === null) {
            this.data = {
                salesTickets: [],
                mvtkTickets: [],
    ...
    PurchaseService.prototype.save = function () {
        this.storage.save('purchase', this.data, __WEBPACK_IMPORTED_MODULE_5__storage_storage_service__["a" /* SaveType */].Session);
    };
    /**
     * リセット
     * @method reset
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        this.storage.save('complete', complete, __WEBPACK_IMPORTED_MODULE_5__storage_storage_service__["a" /* SaveType */].Session);
                        if (!this.awsCognito.isAuthenticate()) return [3 /*break*/, 9];
                        _a.label = 5;
                    case 5:
                        _a.trys.push([5, 8, , 9]);
                        return [4 /*yield*/, this.awsCognito.getRecords({
