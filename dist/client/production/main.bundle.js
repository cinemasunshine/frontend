...
var PurchaseService = /** @class */ (function () {
    ...
    PurchaseService.prototype.getMvtkSeatInfoSync = function (options) {
        ...
        var time = new __WEBPACK_IMPORTED_MODULE_3__pipes_time_format_time_format_pipe__["a" /* TimeFormatPipe */]().transform(this.data.individualScreeningEvent.startDate, coaInfo.dateJouei) + ":00";
